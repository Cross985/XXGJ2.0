    ...
    public class ProcessMethodEdit : Web
    {
        public override void BuildContents()
        {
            ...
            try
            {
                ...
                Entry IntentionOrderidEntry = ProcessMethodNewEntry.GetEntry("pmet_companyid");
                ...
                if (hMode == "Save")
                {
                    ...
                    if (ProcessMethodNewEntry.Validate())
                    {
                        ...
                        string url = UrlDotNet(ThisDotNetDll, "RunProcessMethodSummary") + "&pmet_ProcessMethodid=" + pmet_ProcessMethodid + "&J=ProcessMethod";

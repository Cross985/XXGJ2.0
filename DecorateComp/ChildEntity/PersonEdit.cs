    ...
    public class PersonEdit : Web
    {
        public override void BuildContents()
        {
            ...
            try
            {
                ...
                string cpet_competitorid = DecoratePerson.GetFieldAsString("dper_decoratecompid");
                EntryGroup DecoratePersonNewEntry = new EntryGroup("DecoratePersonNewEntry");
                DecoratePersonNewEntry.Fill(DecoratePerson);
                Entry IntentionOrderidEntry = DecoratePersonNewEntry.GetEntry("dper_decoratecompid");
                ...
                if (errorflag != -1)
                {
                    ...
                    DecoratePersonNewEntry.GetHtmlInEditMode(DecoratePerson);
